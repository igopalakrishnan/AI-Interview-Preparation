...
import { APP_FEATURES } from "../utilis/data";
  ...
  return (
    <>
      <div className="w-full min-h-full bg-[#fffcef]">
        <div className="w-[500px] h-[500px] bg-amber-200/30 blur-[65px] absolute top-0 left-0" />
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2">
              <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                ...
                then,dive deeper into concepts, and organize everything your
